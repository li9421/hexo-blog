...
这玩意挺麻烦的，主要意义还是在于折腾，如果只是单纯的想存笔记的话，隔壁有道云方便快捷
...
>
> 目前记录  1.3 号下午 `Sun Jan  3 07:00:56 UTC` 配置一个 token  到  1.4晚上 23点 `Mon Jan  4 15:23:16 UTC` 目前还是正常，继续观察 , 1.7晚上 `Thu Jan  7 15:28:08 UTC 2021 ` 还是正常。
